  ...
  function SettingsPanel(props) {
    ...
    const accountSyncCard = React.createElement("div", {
      ...
      React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))", gap: 10 } },
        React.createElement("div", { className: "settings-group-card", style: { marginBottom: 0, minHeight: 86, display: "flex", flexDirection: "column", justifyContent: "space-between" } },
