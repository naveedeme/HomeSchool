(() => {
  ...
  const CONTENT_ROLE_PREVIEW_ORDER = ["student", "parent", "teacher", "principal", "school_owner", "editor", "admin"];
  ...
  function SettingsPanel(props) {
    ...
    const contentRoleOptions = [
      ...
      {
        id: "principal",
        label: joinLocalizedText("Principal", "پرنسپل", language),
        capabilities: joinLocalizedText("Supervises teachers and student activity within the school.", "اسکول کے اندر اساتذہ اور طلبہ کی سرگرمی کی نگرانی کرتا ہے۔", language),
      },
      {
        id: "school_owner",
        label: joinLocalizedText("School Owner", "اسکول مالک", language),
        capabilities: joinLocalizedText("Owns school-level configuration, structure, and visibility.", "اسکول کی سطح کی ترتیب، ڈھانچہ، اور نگرانی سنبھالتا ہے۔", language),
      },
      {
        id: "editor",
    ...
    const contentPermissionItems = [
      ...
      { key: "manageParentLinks", label: joinLocalizedText("Manage parent-child links", "والدین اور بچوں کے روابط سنبھالیں", language) },
      { key: "manageInstitution", label: joinLocalizedText("Manage schools and memberships", "اسکول اور ممبرشپس سنبھالیں", language) },
      { key: "manageDiary", label: joinLocalizedText("Manage diary entries", "ڈائری اندراجات سنبھالیں", language) },
      { key: "manageTests", label: joinLocalizedText("Manage Saturday tests", "ہفتہ وار ٹیسٹ سنبھالیں", language) },
