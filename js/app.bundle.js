...
${error.message || error}`);
    ...
    const installStatusLabel = isInstalled ? ui.appInstalled : canInstallApp ? ui.appInstallAvailable : ui.appInstallUnavailable;
